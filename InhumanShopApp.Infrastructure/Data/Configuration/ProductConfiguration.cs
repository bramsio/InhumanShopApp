...
namespace InhumanShopApp.Infrastructure.Data.Configuration
{
    public class ProductConfiguration : IEntityTypeConfiguration<Product>
    {
        ...
        {
            //// Toys
            //new Product() { Id = 1, Name = "Chew Toy", Count = 5, Price = 23.43M, CategoryId = 2,Description  =      "Durable chew toy for dogs.", ImageUrl = "/images/chew_toy.jpg" },
            //new Product() { Id = 2, Name = "Cat Ball", Count = 5, Price = 15.99M, CategoryId = 2,Description  =      "Colorful ball with bell for cats.", ImageUrl = "/imagescat_ball.jpg" },
            //new Product() { Id = 3, Name = "Bird Swing", Count = 5, Price = 12.49M, CategoryId = 2,Description =       "Swing toy for small birds.", ImageUrl = "/images/bird_swing.jpg" },
            //new Product() { Id = 4, Name = "Hamster Tunnel", Count = 5, Price = 18.75M, CategoryId = 2,  Description =    "Plastic tunnel for hamsters.", ImageUrl = "/images/hamster_tunnel.jpg" },
            //new Product() { Id = 5, Name = "Interactive Feeder", Count = 5, Price = 29.99M, CategoryId = 2,      Description = "Puzzle feeder to engage pets.", ImageUrl = "imagesinteractive_feeder.jpg" },
